...
# TODO: see complex.py file comments about subtle items to fix.
...
def proto_definition_to_strawberry_graphql_schema(proto_def: MessageMeta) -> List[str]:
    ...
    while not proto_definitions_to_process.empty():
        ...
        header = '# This definition was generated by the protobuf utility graphql transform. DO NOT EDIT!'
...
def proto_definition_to_strawberry_type(
    ...
    if isinstance(proto_descriptor, Descriptor):
        return _message_definition_to_strawberry_type(
        ...
        return _enum_definition_to_strawberry_type(
...
def _message_definition_to_strawberry_type(
    ...
    for nested_enum in proto_descriptor.enum_types:
        nested_enum_str = _enum_definition_to_strawberry_type(nested_enum, imports, indent_count+1)
    ...
    for nested_class in proto_descriptor.nested_types:
        nested_str = _message_definition_to_strawberry_type(
...
def _enum_definition_to_strawberry_type(
